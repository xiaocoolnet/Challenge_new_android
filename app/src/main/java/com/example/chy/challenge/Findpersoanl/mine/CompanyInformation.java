...
//
//import com.example.chy.challenge.Findpersoanl.mine.bean.CompanyInfo;
...
//        mContext = this;
////        company = new CompanyInfo(mContext);
...
//                break;
//            case R.id.compelete:
//                setResult(RESULT_OK,new Intent().putExtra("comname",company_name.getText()));
//                finish();
//                break;
