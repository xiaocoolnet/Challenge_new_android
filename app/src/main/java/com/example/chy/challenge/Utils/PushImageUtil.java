...
import com.example.chy.challenge.AppApplication;
...
public class PushImageUtil {
    ...
    public void pushImg(final String picPath,final int KEY){
        new Thread(){
            ...
            public void run() {
                ...
                String result = NetBaseUtils.getResponseForImg(UserNetConstant.UPLOADAVATAR, params, mContext);
                try {
    ...
    public void compressImageWithRatio(PhotoWithPath photoWithPath,int addImgKey){
        File appDir = new File(Environment.getExternalStorageDirectory(), "tiaozhangaoxin");
        if (!appDir.exists()) {
            appDir.mkdir();
        }
    ...
    public void updatePhoto(final File f,final int KEY){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                String url1= UserNetConstant.UPLOADAVATAR;
                ...
                AppApplication.getFileRequestQueue().add(request);
            }
        }.start();
