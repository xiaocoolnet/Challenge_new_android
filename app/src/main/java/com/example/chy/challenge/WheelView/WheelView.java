...
package com.example.chy.challenge.WheelView;
...
import com.example.chy.challenge.WheelView.adapters.AbstractWheelTextAdapter;
import com.example.chy.challenge.WheelView.adapters.ArrayWheelAdapter;
import com.example.chy.challenge.WheelView.adapters.WheelViewAdapter;
...
//	private int[] SHADOWS_COLORS = new int[] { 0xefFFFFFF, 0xcfFFFFFF, 0x3fFFFFFF };
	private int[] SHADOWS_COLORS = new int[] { 0x00E9E9E9, 0x00E9E9E9, 0x00E9E9E9 };
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		...
		if (viewAdapter instanceof ArrayWheelAdapter) {
			ArrayWheelAdapter textAdapter = (ArrayWheelAdapter) viewAdapter;
			// 设置选中的字体和颜色
			TextView textView = textAdapter.getTextViewByIndex(newValue);
			if (textView != null) {
				textView.setTextColor(AbstractWheelTextAdapter.CHOOSE_TEXT_COLOR);
				textView.setTextSize(AbstractWheelTextAdapter.CHOOSE_TEXT_SIZE);
			}

			// 恢复未选中字体的颜色和大小
			textView = textAdapter.getTextViewByIndex(oldValue);
			if (textView != null) {
				System.out.println(oldValue+":oldValue");
				textView.setTextColor(AbstractWheelTextAdapter.DEFAULT_TEXT_COLOR);
				textView.setTextSize(AbstractWheelTextAdapter.DEFAULT_TEXT_SIZE);
			}
		}
	}
