 ...
 */
package com.example.chy.challenge.WheelView.adapters;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    /** Default text color */
    public static final int DEFAULT_TEXT_COLOR = 0xFF535353;
    public static final int CHOOSE_TEXT_COLOR =  0xFF64D991;
    public static final int ITEM_HEIGHT = 45;//单位是dp
    ...
    public static final int CHOOSE_TEXT_SIZE = 16;
    ...
    protected void configureTextView(TextView view, int index) {
    	if (index == currentItem) {
			view.setTextColor(AbstractWheelTextAdapter.CHOOSE_TEXT_COLOR);
			view.setTextSize(AbstractWheelTextAdapter.CHOOSE_TEXT_SIZE);
		} else {
    	...
    	LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT,  (int) (ITEM_HEIGHT * scale + 0.5f));
