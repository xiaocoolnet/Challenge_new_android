...
public class CompanyImageView extends ImageView {
    ...
    public CompanyImageView(Context context, AttributeSet attrs) {
    ...
    public CompanyImageView(Context context, AttributeSet attrs, int defStyle) {
