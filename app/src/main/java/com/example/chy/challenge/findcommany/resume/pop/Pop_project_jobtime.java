package com.example.chy.challenge.findcommany.resume.pop;
 ...
 */
public class Pop_project_jobtime implements PopupWindow.OnDismissListener, View.OnClickListener{

    private static final int UPDATEBIRTHDAY = 1;
    private Write_personal_prohect mactivity;
    private PopupWindow popupWindow;
    private TextView mine_pop_cancle, mine_pop_sure;
    private WheelView id_leftyear, id_rightyear,id_centeryear;
    private String et_content,pagetype;
    private View rootView;
    private TextView tv_project_starttime,tv_project_endtime;
    ...
    public String mYear;
    public Pop_project_jobtime(Write_personal_prohect mActivity) {
...
//        id_rightyear.addChangingListener(this);
        ...
        tv_project_starttime = (TextView)rootView.findViewById(R.id.work_tv_commany_industry);//项目开始时间
        tv_project_endtime = (TextView) rootView.findViewById(R.id.work_tv_Position_type);//项目结束时间
...
//                if (leftyear > rightyear) {
                    if ("end".equals(pagetype)){
                        tv_project_starttime.setText(LeftYears[leftyear]);
                    }else if ("start".equals(pagetype)){
                        tv_project_endtime.setText(LeftYears[leftyear]);
//                    }
                    dissmiss();
                }else{
