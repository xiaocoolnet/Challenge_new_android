...
public class Search_child_job extends BaseAdapter {
    ...
    public Search_child_job(List<String> list, Context mContext, int type) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case 0:
                ...
                holderview.tv_child_jobtype.setBackgroundResource(R.color.white);  //其他项背景
                holderview.tv_child_jobtype.setTextColor(mContext.getResources().getColor(R.color.gray4));
                break;
        }
        return convertView;
    }
