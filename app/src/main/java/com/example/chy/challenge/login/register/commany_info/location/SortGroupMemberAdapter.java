...
//				viewHolder.tvTitle = (TextView) view.findViewById(R.id.title);
				...
				viewHolder.location_griview = (GridView) view.findViewById(R.id.location_griview);
			}else {
				view = LayoutInflater.from(mContext).inflate(R.layout.activity_group_member_item, null);
//				viewHolder.tvTitle = (TextView) view.findViewById(R.id.title);
				viewHolder.tvLetter = (TextView) view.findViewById(R.id.catalog);
		...
		if (position == getPositionForSection(section)) {
			...
			childlist.clear();
			childlist.add(this.list.get(position).getName());
			sortchild = new Sort_child(mContext,childlist,0);
			viewHolder.location_griview.setAdapter(sortchild);
		}
