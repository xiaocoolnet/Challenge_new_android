 ...
 */
public class Commany_personal_jobtime implements PopupWindow.OnDismissListener, View.OnClickListener{
    ...
    public Commany_personal_jobtime(Register_Commany_info mActivity) {
...
//        id_rightyear.addChangingListener(this);
        ...
        tv_jobtime = (TextView) rootView.findViewById(R.id.commany_tv_jobtime);
    ...
    private void initProvinceDatas() {
        if (NetBaseUtils.isConnnected(mactivity)) {
            new UserRequest(mactivity, handler).GETDICTIONARYLIST("52", GETEDUCATION);
        } else {
            Toast.makeText(mactivity, R.string.net_error, Toast.LENGTH_SHORT).show();
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mine_pop_sure:
                ...
                tv_jobtime.setText(education[leftyear]);
                dissmiss();
                break;
        }
    }
